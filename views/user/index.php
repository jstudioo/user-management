...
use jstudioo\UserManagement\components\GhostHtml;
use jstudioo\UserManagement\models\rbacDB\Role;
...
use jstudioo\extensions\GridBulkActions\GridBulkActions;
use jstudioo\extensions\GridPageSize\GridPageSize;
use yii\grid\GridView;

/**
 * @var yii\web\View $this
 * @var yii\data\ActiveDataProvider $dataProvider
 * @var jstudioo\UserManagement\models\search\UserSearch $searchModel
 */
		...
		<div class="panel-body">
			...
			<?= GridView::widget([
				...
				'columns' => [
					...
					[
						'class'=>'jstudioo\UserManagement\components\StatusColumn',
