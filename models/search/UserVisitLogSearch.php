...
namespace jstudioo\UserManagement\models\search;
...
/**
 * UserVisitLogSearch represents the model behind the search form about `jstudioo\UserManagement\models\UserVisitLog`.
 */
