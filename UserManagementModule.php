...
namespace jstudioo\UserManagement;
...
class UserManagementModule extends \yii\base\Module
{
	 ...
	 * @var string
	 */
	public $registrationFormClass = 'jstudioo\UserManagement\models\forms\RegistrationForm';
	...
	public $controllerNamespace = 'jstudioo\UserManagement\controllers';
	...
	public static function t($category, $message, $params = [], $language = null)
	{
		if ( !isset(Yii::$app->i18n->translations['modules/user-management/*']) )
		{
			Yii::$app->i18n->translations['modules/user-management/*'] = [
				...
				'sourceLanguage' => 'en',
				'basePath'       => '@vendor/jstudioo/user-management/messages',
				'fileMap'        => [
